...
<head>
    ...
    <link rel="stylesheet" href="Faculty'sSubjectStyle.css">
</head>
<body>
    
    <h5>Faculty's Subjects</h5>

    <p>None of the items were selected</p>

    <div class="tools">
        <form class="file" action="Faculty'sSubjectform.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="Pop">
        ...
        <div class="addContent">
            ...
            <form action="Faculty'sSubjectform.php" method="POST">
                <h5>Add Course</h5>
                <table>
                    <tr class="group">
                        <th class="th">
    ...
    <div class="t-content">
        <table>
            ...
            <?php
                ...
                $query = "SELECT `Faculty's Subject`.`Employee ID`,`Employee`.`Employee Name`,`Faculty's Subject`.`Subject ID`,`Subjects`.`Subject Name`,`Batches`.`Batch Name` FROM `Employee`,`Faculty's Subject`,`Subjects`,`Batches` WHERE `Employee`.`Employee ID` = `Faculty's Subject`.`Employee ID` AND `Faculty's Subject`.`Subject ID` = `Subjects`.`Subject ID` AND `Faculty's Subject`.`Batch ID` = `Batches`.`Batch ID`";
            ...
            <?php
                ...
                if($result){
                    while($i = mysqli_fetch_assoc($result)){
                      echo '<tr>
                                <td><input name="box[]" type="checkbox" value="' . $i['Employee ID'] . ' ' . $i['Subject ID'] . '"></td>
                                <td>' . $i['Employee ID'] . '</td>
